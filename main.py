...
def attack(char_name: str, char_class: str) -> str:
    """Измеряет нанесённый урон противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Измеряет количетсво заблокированного урона."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} ты получил урон')


def special(char_name: str, char_class: str) -> str:
    """Показывает спец способности классов."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} ты ничего не сделал')
